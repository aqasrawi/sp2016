...
configuration ConfigureSharePointServer
{
    ...
    $ModuleFilePath="$PSScriptRoot\MSFT_SPCreateFarm.psm1"
    ...
    Import-DscResource -ModuleName xComputerManagement, xActiveDirectory, cConfigureSharepoint, xCredSSP, SharePointDSC
